...
class PlaneDetector:
    def __init__(self):
        ...
        self.unit_scale = 1000.0 if self.output_unit == 'centimeter' else 1.0  # 单位转换因子
    ...
    def image_callback(self, rgb_msg, depth_msg):
        ...
        try:
            ...
            # for i, corner in enumerate(corners_camera):
    ...
    def create_corner_visualization(self, rgb, corners_3d_camera, corners_3d_converted):
        ...
        try:
            ...
            info_text = [
                ...
                f"(left)near: ({corners_3d_converted[0][0]:.1f}, {corners_3d_converted[0][1]:.1f}, {corners_3d_converted[0][2]:.1f})mm",
                f"(right)near: ({corners_3d_converted[1][0]:.1f}, {corners_3d_converted[1][1]:.1f}, {corners_3d_converted[1][2]:.1f})mm",
                f"(right)far: ({corners_3d_converted[2][0]:.1f}, {corners_3d_converted[2][1]:.1f}, {corners_3d_converted[2][2]:.1f})mm",
                f"(left)far: ({corners_3d_converted[3][0]:.1f}, {corners_3d_converted[3][1]:.1f}, {corners_3d_converted[3][2]:.1f})mm"
            ]
    ...
    def process_images(self, rgb, depth, mask):
        ...
        return plane_normal_shift, corner_points_3d, corner_points_3d_camera
    ...
    def sort_corners(self, corners_3d):
        ...
        try:
            ...
            sorted_corners = [
                top_corners[0][2],      # P1: （左）近距点 (Left-Near)
                top_corners[1][2],      # P2: （右）近距点 (Right-Near)
                bottom_corners[1][2],   # P3: （右）远距点 (Right-Far)
                bottom_corners[0][2]    # P4: （左）远距点 (Left-Far)
            ]
